...
SCENES = [
    ...
    S("j02", 4.44, 9.36, "haneda_departure", 1.00, 1.10, cy0=.55, cy1=.45, fog=.14),
    S("j03", 9.36, 15.22, "flight_map", 1.02, 1.10, cx0=.56, cy0=.52, cx1=.46, cy1=.44),
    ...
    S("j20", 107.07, 117.11, "flight_map", 1.08, 1.16, cx0=.48, cy0=.44,
      cx1=.38, cy1=.38, wob=.4),
    ...
    S("j29", 179.77, 188.25, "tailstrike_1978", 1.02, 1.11, cx0=.44, cx1=.26,
      cy0=.46, cy1=.62, wob=.5),
    ...
    # ---------------- 5. 7年間 ----------------
    S("j38", 246.90, 253.90, "cycles_counter", 1.00, 1.07, cy0=.44, cy1=.56),
    ...
    S("j58", 415.60, 424.20, "night_search", 1.09, 1.02, cx0=.60, cx1=.44,
      fog=.30, flick=.08),
    S("j59", 424.20, 434.30, "dawn_rescue", 1.00, 1.08, cy0=.46, cy1=.54, fog=.24),
    S("j60", 434.30, 447.00, "survivors_card", 1.00, 1.07, wob=.3),
    S("j61", 447.00, 458.00, "memorial", 1.02, 1.09, cy0=.52, cy1=.44, fog=.26),
    ...
    S("j96", 882.90, 890.10, "memorial", 1.06, 1.00, fog=.28),
    ...
    S("j109", 1032.00, 1046.00, "memorial", 1.00, 1.07, cy0=.52, cy1=.44, fog=.28),

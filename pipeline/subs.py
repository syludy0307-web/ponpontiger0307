...
def cues():
    ...
    # map scene
    ev(2, 22.1, 31.3, "Mono",
       f"{{\\an8\\pos(960,52)\\fs38\\1c{CYAN}\\bord2.6\\fsp4\\fad(200,150)}}"
       "解体済みは除外 ── 現存する建物のみを厳選")
    ev(2, 25.3, 31.3, "Serif",
       f"{{\\an5\\pos(1620,330)\\fs86\\1c{RED}\\bord5\\3c&HE8E8F0&\\xbord6\\ybord6"
       f"\\frz-11\\fscx320\\fscy320\\t(0,130,0.5,\\fscx100\\fscy100)\\fad(20,160)}}全件現存")
    smalltag(28.95, 31.4, "COUNTDOWN ▶", 1642, 880, 34, RED, an=7)

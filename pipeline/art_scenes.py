...
def japan_map(seed=40):
    ...
    KYU = [(286, 714), (322, 730), (330, 780), (306, 830), (260, 844), (236, 796),
           (250, 744)]
    sx, sy = AH * 1.40 / 1000.0, AH * 1.40 / 1000.0
    ox, oy = AW * 0.5 - 560 * sx, AH * 0.55 - 480 * sy
    ...
    d = ImageDraw.Draw(img, "RGBA")
    pins = [("黒瀬病院", "広島", (372, 676), (-260, 40)),
            ("旧相武病院", "東京", (694, 612), (150, 90)),
            ("旧野木病院", "栃木", (706, 570), (150, -60)),
            ("小美玉小川脳病院", "茨城", (740, 552), (140, -130)),
            ("姫川病院", "新潟", (612, 528), (-330, -90))]
    f1 = B.font(52, "black")
    f2 = B.font(36, "bold")

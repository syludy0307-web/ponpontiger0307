...
def cues():
    ...
    headline(714.9, 722.0, "重要なのは、物的証拠の向きだ", 960, 250, 78, AMB,
             serif=False)
    headline(729.6, 742.0, "すべてが同じ方向を向いている", 960, 950, 58, AMB,
             serif=False)

    # ===== 11. 救助 =====
    headline(742.6, 754.3, "では、救助の遅れは?", 960, 250, 92, WHITE, serif=False)
    headline(757.0, 767.2, "疑問が残る部分は、確かにある", 960, 950, 62, AMB,
             serif=False)
    ...
    headline(874.0, 882.9, "不信感が、一つの巨大な物語につながった", 960, 950, 54,
             PALE, serif=False)
